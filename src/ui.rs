...
pub struct ProfilerStats {
    ...
    pub configured_near_radius: i32,
    pub configured_mid_radius: i32,
    pub configured_far_radius: i32,
    pub configured_ultra_radius: i32,
    pub effective_near_radius: i32,
    pub effective_mid_radius: i32,
    pub effective_far_radius: i32,
    pub effective_ultra_radius: i32,
    pub configured_lod_hysteresis: i32,
    pub effective_lod_hysteresis: i32,
    pub configured_lod_budget_near: usize,
    pub configured_lod_budget_mid: usize,
    pub configured_lod_budget_far: usize,
    pub configured_lod_budget_ultra: usize,
    pub effective_lod_budget_near: usize,
    pub effective_lod_budget_mid: usize,
    pub effective_lod_budget_far: usize,
    pub effective_lod_budget_ultra: usize,
    ...
    if ui_state.show_debug {
        egui::Window::new("Debug / Performance")
            ...
            .show(ctx, |ui| {
                ...
                ui.monospace(format!(
                    "lod radii configured n/m/f/u: {}/{}/{}/{} | effective n/m/f/u: {}/{}/{}/{}",
                    ui_state.profiler.configured_near_radius,
                    ui_state.profiler.configured_mid_radius,
                    ui_state.profiler.configured_far_radius,
                    ui_state.profiler.configured_ultra_radius,
                    ui_state.profiler.effective_near_radius,
                    ui_state.profiler.effective_mid_radius,
                    ui_state.profiler.effective_far_radius,
                    ui_state.profiler.effective_ultra_radius,
                ));
                ui.monospace(format!(
                    "lod hysteresis configured/effective: {}/{} | budgets configured n/m/f/u: {}/{}/{}/{} | effective n/m/f/u: {}/{}/{}/{}",
                    ui_state.profiler.configured_lod_hysteresis,
                    ui_state.profiler.effective_lod_hysteresis,
                    ui_state.profiler.configured_lod_budget_near,
                    ui_state.profiler.configured_lod_budget_mid,
                    ui_state.profiler.configured_lod_budget_far,
                    ui_state.profiler.configured_lod_budget_ultra,
                    ui_state.profiler.effective_lod_budget_near,
                    ui_state.profiler.effective_lod_budget_mid,
                    ui_state.profiler.effective_lod_budget_far,
                    ui_state.profiler.effective_lod_budget_ultra,
                ));
                ui.monospace(format!(
                    "rebuilt shells n/m/f/u: {}/{}/{}/{}",
